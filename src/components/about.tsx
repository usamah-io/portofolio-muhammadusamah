            ...
            <div key={idx} ref={addToRefs} className="relative pl-6 sm:pl-10 group">
              ...
              <div className="bg-white dark:bg-zinc-900/50 dark:backdrop-blur-md border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6 transition-all duration-300 hover:border-emerald-500/50 hover:shadow-[0_0_20px_rgba(16,185,129,0.05)] shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-5 pt-4 border-t border-zinc-100 dark:border-zinc-800/50">
                  ...
                  {/* Action Buttons (Instagram, Website, Recap) */}
                  {("instagram_link" in item || "web_link" in item || "recap_link" in item) && (
                    <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
                      {"recap_link" in item && item.recap_link && (
                        <a
                          href={item.recap_link as string}
                          className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-450 hover:to-teal-450 text-zinc-950 text-xs font-extrabold transition-all duration-300 shadow-md shadow-emerald-500/20 cursor-pointer"
                        >
                          ...
                          <span>{"recap_label" in item ? (item.recap_label as string) : "Rekap Nilai & Galeri ↗"}</span>
                        </a>
                      )}
